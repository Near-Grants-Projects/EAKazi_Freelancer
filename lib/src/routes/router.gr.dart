...
import 'package:ea_kazi/src/features/jobs&courses/presentation/jobs/jobs_screen.dart'
    as _i3;
import 'package:ea_kazi/src/features/wallet/wallet_screen.dart' as _i4;
...
class AppRouter extends _i6.RootStackRouter {
  ...
  final Map<String, _i6.PageFactory> pagesMap = {
    ...
    WalletRoute.name: (routeData) {
      return _i6.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i4.WalletScreen());
    },
  ...
  List<_i6.RouteConfig> get routes => [
        _i6.RouteConfig(OnBoardingRoute.name, path: '/on-boarding-screen'),
        ...
        _i6.RouteConfig(DefaultWrapperRoute.name, path: '/', children: [
